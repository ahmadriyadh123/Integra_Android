...
class DailyNoteCard extends StatelessWidget {
  ...
  bool get hasUserNote => savedResponse != null;
            ...
            child: Column(
              ...
              children: [
                ...
                if (savedResponse != null)
                  _buildSavedResponseBox(savedResponse!)
                else ...[
                  TextField(
  ...
  Widget _buildSavedResponseBox(String response) {
    return Container(
      width: double.infinity,
    ...
    return Row(
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: (hasTeacherNote || hasUserNote) ? const Color(0xFFECFDF5) : const Color(0xFFF1F5F9),
            borderRadius: BorderRadius.circular(20),
            border: Border.all(
              color: (hasTeacherNote || hasUserNote) ? const Color(0xFFA7F3D0) : const Color(0xFFE2E8F0),
            ),
          ),
          child: Text(
            (hasTeacherNote || hasUserNote) ? 'Ada Catatan' : 'Tidak Ada Catatan',
            style: TextStyle(
              fontSize: 10,
              fontWeight: FontWeight.w700,
              color: (hasTeacherNote || hasUserNote) ? primaryTeal : textSlate,
            ),
          ),
        ),
      ],
  ...
  Widget _buildEmptyNoteBox(Color textSlate) {
    return Container(
      ...
      child: Text(
        'Belum ada isi harian untuk hari ini (-)',
